                ...
                .then((res)=>{
                    ...
                    try {                    
                        if( result === null ){ // null 이면 가입회원이 아닙니다. 회원가입하세요                      
                            ...
                            // 키와 키값을 전송
                            confirmModalOpen(' 가입 회원의 비밀번호를 확인하고 로그인하세요!');    
                                    ...
                                    (
                                        <>
                                            ...
                                            <li>
                                                ...
                                                ref={userNameRef} 
                                                />
                                                {userId!=='' && <a onClick={(e)=>onClickIconDel(e, 'userName')} href="!#"><img src="./images/sigin_in/icon_del.svg" alt="" /></a>}
                                            </li>
